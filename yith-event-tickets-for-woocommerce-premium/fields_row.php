            ...
            switch ($field['_type']) {
                ...
                case 'text':
                    ...
                    <p class="form-field _fields_customer_<?php echo $label; ?>_field ">
                        <?php if (!$placeholder){ ?>
                            <label
                                    for="_fields_customer_<?php echo $row ?>_<?php echo $label; ?>"><?php echo stripslashes($field['_label']); ?><?php if (isset($field['_required'])) {
                ...
                case 'yes-no':
                    ...
                    <p class="form-field _fields_customer_<?php echo $label; ?>_field">
                        ...
                        <input type="radio"
                               ...
                               required><?php echo __( 'Yes', 'yith-event-tickets-for-woocommerce'); ?>
                        <input type="radio"
                               name="_fields_customer[<?php echo $row ?>][<?php echo $index ?>][_value]"
                               value="no"
                               class="field_item_radio_input yes-no_option_no"
                               required><?php echo __( 'No', 'yith-event-tickets-for-woocommerce'); ?>
                    </p>
                    <?php
                    break;
                case 'check':
