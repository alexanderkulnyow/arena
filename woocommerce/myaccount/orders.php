...
<?php if ( $has_orders ) : ?>
		...
		foreach ( $customer_orders->orders as $customer_order ) {
            ...
            <div class="orders__row">
				<?php foreach ( wc_get_account_orders_columns() as $column_id => $column_name ) : ?>
                    <div class="" data-title="<?php echo esc_attr( $column_name ); ?>">
						<?php if ( has_action( 'woocommerce_my_account_my_orders_column_' . $column_id ) ) : ?>
							<?php do_action( 'woocommerce_my_account_my_orders_column_' . $column_id, $order ); ?>

						<?php elseif ( 'order-number' === $column_id ) : ?>
                            <div class="order__item order__number">
                                <span class="cart__item-tag">Номер заказа:</span>
                        ...
                        <div class="order__date">
                            <span class="cart__item-tag">Дата заказа:</span>
                        ...
                        <div class="order__status">
                            <span class="cart__item-tag">Статус заказа:</span>
						...
						<?php elseif ( 'order-total' === $column_id) : ?>
                            <div class="order__total">
                                <span class="cart__item-tag">Сумма заказа:</span>
	                            <?php
						...
						<?php elseif ( 'order-actions' === $column_id ) : ?>
                            <div class="order__actions order__item">
	                            <?php
    ...
    <!--	<table class="woocommerce-orders-table woocommerce-MyAccount-orders shop_table shop_table_responsive my_account_orders account-orders-table table__order">-->
    <!--		<thead class="">-->
    <!--			<tr>-->
    <!--				--><?php //foreach ( wc_get_account_orders_columns() as $column_id => $column_name ) : ?>
